...
function PagePlayer() {
  ...
  this.css = {              // CSS class names appended to link during various states
    sDefault: 'player_def',
    sLoading: 'player_load',
    sPlaying: 'player_play',
    sPaused: 'player_pause'    
  };
  ...
  this.vuMeterData = [];
  this.oControls = null;
  //this.oControls = document.getElementById('controls-song');
  ...
  this.handleClick = function(e) {
    ...
    if (!o.href || (!sm.canPlayLink(o) && !self.hasClass(o,'playable')) || self.hasClass(o,'exclude')) {
      ...
      if (thisSound) {
        ...
        //oControls = document.getElementById('show-song-data').cloneNode(true);
        ...
        thisSound._data = {
          ...
          oStatus: self.select('barra_progreso',oLI),
  ...
  this.init = function(oConfig) {
    ...
    controlTemplate.setAttribute('id', 'datosDelPlayer');
     ...
     controlTemplate.innerHTML = [
      ...
      '    <span>Duracion: </span><span class="sm2_total">%s2</span>',
      '   </div>',
      '  </div>',
